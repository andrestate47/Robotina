            ...
            messages: [
              {
                role: "user",
                content: [
                  { type: "text", text: "Look at the text in the chart image carefully. Identify the financial asset displayed. Your goal is to return the PRECISE Ticker Symbol used in financial markets.\n\nCRITICAL RULES:\n1. Translate common asset names to their most popular ETF or Ticker: 'S&P 500' -> 'SPY', 'Nasdaq' / 'Nasdaq 100' -> 'QQQ', 'Dow Jones' -> 'DIA', 'Gold' -> 'XAUUSD', 'Bitcoin' -> 'BTC'.\n2. If you see a clear ticker like 'AAPL', 'TSLA', 'EURUSD', return it exactly.\n3. DO NOT use generic index tickers like '^GSPC' or 'SPX', use 'SPY' instead. For Nasdaq use 'QQQ'.\n4. EXTREMELY IMPORTANT: If you CANNOT find ANY text indicating the asset name or ticker (e.g., the image is just candles with no labels), you MUST return EXACTLY the word 'UNKNOWN'. But if you read 'S&P 500', 'Gold', etc., DO NOT return UNKNOWN, return its ticker.\n\nReturn ONLY the symbol string or 'UNKNOWN'. No explanations." },
